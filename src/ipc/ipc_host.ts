...
import { registerModeHandlers } from "./handlers/mode_handlers";
import { registerDistributedMemoryHandlers } from "./handlers/distributed_memory_handlers";
...
export function registerIpcHandlers() {
  ...
  registerDistributedMemoryHandlers();
}
